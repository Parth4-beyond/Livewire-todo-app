<div id="create-form" class="hover:shadow p-6 bg-white border-blue-500 border-t-2">
    ...
    <div x-data="{ open: false }" class="border rounded-lg mt-2">
        <button @click="open = !open" class="bg-blue-500 text-white p-3 w-full">
            What's this todo about?
        </button>
        <div x-show="open" class="p-3 bg-gray-100">
            Organize your life with ease. Our to-do app helps you stay on top of tasks, set reminders, and track
            progress. Create personalized lists, prioritize items, and achieve your goals efficiently.
        </div>
    </div>
    <form wire:submit="create">
        ...
        <div class="mt-2">
            <button type="submit" wire:loading.remove wire:target="create"
                ...
                +</button>
            <button wire:loading type="button" wire:target="create"
